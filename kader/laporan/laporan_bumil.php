...
<body id="page-top">
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <!--------------------------konten-------------------------------------------------------->
      <h3><i class="fa-solid fa-file"></i> Laporan Data Pemeriksaan Ibu Hamil</h3>
      <hr>
      ...
      <form method="get">
        ...
        <table style="width:100%">
          ...
          if (isset($_GET['tanggal_periksa'])) {
            ...
            $sql = mysqli_query($koneksi, "select * from daftar_bumil where tanggal_periksa='$tgl'");
          } else {
            $sql = mysqli_query($koneksi, "select * from daftar_bumil");
          }
          ...
          ?>
            <tr>
              ...
              <td><?php echo $data['nama_bumil']; ?></td>
              <td><?php echo $data['usia_bumil']; ?></td>
              <td><?php echo $data['usia_hamil']; ?></td>
              <td><?php echo $data['bb_bumil']; ?></td>
              <td><?php echo $data['t_darah']; ?></td>
              <td><?php echo $data['hb']; ?></td>
              <td><?php echo $data['tanggal_periksa']; ?></td>
              <td><?php echo $data['hamil_brp']; ?></td>
            </tr>
        ...
        if (isset($_GET['tanggal'])) {
          ...
          <div class="float-right">
            <a href="../../cetak/cetak_bumil.php?tanggal=<?= $tgl ?>" target="_blank" class="btn btn-success"><i class="fa-solid fa-print"></i> &nbsp PRINT</a>
            <a href="utama.php" class="btn btn-primary role" role=" button"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
            <br>
          </div>
        <?php } else { ?>
          <div class="float-right">
            <a href="../../cetak/cetak_bumil.php" target="_blank" class="btn btn-success"><i class="fa-solid fa-print"></i> &nbsp PRINT</a>
            <a href="utama.php" class="btn btn-primary role" role=" button"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
          </div>
