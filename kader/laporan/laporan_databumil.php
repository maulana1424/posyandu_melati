  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <form method="get">
        ...
        <input type="text" name="nama_bumil">
        ...
        <table style="width:100%">
          ...
          if (isset($_GET['nama_bumil'])) {
            $tgl = $_GET['nama_bumil'];
            $sql = mysqli_query($koneksi, "select * from bumil where nama_bumil='$tgl'");
          } else {
            $sql = mysqli_query($koneksi, "select * from bumil");
          }
        ...
        if (isset($_GET['nama_bumil'])) {
          ...
          <div class="float-right">
            <a href="../../cetak/cetak_databumil.php?tanggal=<?= $tgl ?>" target="_blank" class="btn btn-success"><i class="fa-solid fa-print"></i> &nbsp PRINT</a>
            <a href="utama.php" class="btn btn-primary role" role=" button"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
            <br>
          </div>
        <?php } else { ?>
          <div class="float-right">
            <a href="../../cetak/cetak_databumil.php" target="_blank" class="btn btn-success"><i class="fa-solid fa-print"></i> &nbsp PRINT</a>
            <a href="utama.php" class="btn btn-primary role" role=" button"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
          </div>
