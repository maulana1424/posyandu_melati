  ...
  <div class="row mt-4">
    <div class="col-md-2 mt-2 pr-3 pt-4 bg-secondary">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="jadwal.php"><i class="fa-solid fa-table"></i>
            Table Jadwal</a>
          <hr>
        </li>
    </div>
    <div class="col-md-10 p-5 pt-5">
      ...
      <!--------------------------konten-------------------------------------------------------->
      <h3><i class="fa-solid fa-table"></i> Input jadwal Kegiatan Posyandu</h3>
      <hr>
      <form method="POST" action="../../wa/wa.php">
        <h3><label for="jadwal">Jadwal Kegiatan Posyandu Melati</label></h3><br>
        <div class="form-group">
          <textarea class="input" style="resize:none; width:500px; height:400px; " id="jadwal" placeholder="Masukan Jadwal Kegiatan Posyandu" name="jadwal" autofocus required autocomplete="off"></textarea><b>
        </div>
        <br>
        <!-- <button type="submit" class="btn btn-primary" name="tambah">Simpan</button></b> -->
        <button type="submit" class="btn btn-success"><i class="fa-brands fa-whatsapp"></i> kirim</button></b>
        <!-- <a href="../wa/wa.php" class="btn btn-primary">Kirim</a></b> -->
