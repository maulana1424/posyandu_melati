            ...
            foreach ($cam as $cmb) : ?>
              <tr>
                ...
                <td class="list-group-item">
                  <a href="detail.php?id_bumil=<?= $cmb['id_bumil']; ?>" class="btn btn-warning" role="button"><i class="fa-solid fa-id-badge"></i></i> Profil</a>
                  <a href="hapus.php?id_bumil=<?= $cmb['id_bumil']; ?>" onclick="return confirm('Yakin Hapus?')" class="btn btn-danger" role="button"><i class="fa-regular fa-trash-can"></i></a>
                </td>
              </tr>
              <?php $id++ ?>
            <?php endforeach ?>
