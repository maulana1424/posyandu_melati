...
require '../../function/function_pbumil.php';
$tgl = date("Y-m-d");
$id = $_GET['id_bumil'];
    ...
    <div class="col-md-10 mt-10 pr-5 pt-5">
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          <label for="id_bumil">ID Ibu Hamil</label>
          <input type="text" readonly class="form-control" id="id_bumil" value="<?= $cam['id_bumil'] ?>" name="id_bumil" autofocus required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="nama_bumil">Nama Ibu Hamil</label>
          <input type="text" class="form-control" id="nama_bumil" value="<?= $cam['nama_bumil'] ?>" name="nama_bumil" autofocus required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="usia_bumil">Usia Ibu Hamil</label>
          <input type="text" class="form-control" id="usia_bumil" placeholder="Usia Ibu Hamil" name="usia_bumil" required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="usia_hamil">Usia Kehamilan</label>
          <input type="text" class="form-control" id="usia_hamil" placeholder="Usia Kehamilan" name="usia_hamil" required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="bb_bumil">Berat Badan</label>
          <input type="text" class="form-control" id="bb_bumil" placeholder="Berat Badan" name="bb_bumil" required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="t_darah">Tekanan Darah</label>
          <input type="text" class="form-control" id="t_darah" placeholder="Tekanan Darah" name="t_darah" required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="hb">Kadar HB</label>
          <input type="text" class="form-control" id="hb" placeholder="Kadar HB" name="hb" required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="tanggal_periksa">Tanggal Periksa</label>
          <input type="date" class="form-control" id="tanggal_periksa" value="<?= $tgl; ?>" name="tanggal_periksa" required autocomplete="off">
        </div>
