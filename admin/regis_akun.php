...
if (isset($_POST['daftar'])) {
  if (regis($_POST) > 0) {
    ...
    document.location.herf = 'utama.php';
    </script>";
  } else {
    "<script>
    ...
    <div class="col-md-10 mt-10 pr-5 pt-5">
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="passworda" placeholder="Masukan Password" name="passworda" required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="ulang_password">Ulang Password</label>
          <input type="text" class="form-control" id="ulang_password" placeholder="Ulang Password" name="ulang_password" required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="no_hp">No HandPhone</label>
          <input type="text" class="form-control" id="no_hp" placeholder="Masukan Nomor HandPhone" name="no_hp" required autocomplete="off">
        </div><br>

        <div class="form-group">
          <label for="levela">Daftar Sebagai</label>
          <select name="levela">Pilih Akun
        ...
        <br>
        <button type="submit" class="btn btn-primary" name="daftar"> Daftar Akun</button></b>
      </form>
