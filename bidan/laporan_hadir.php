...
<body id="page-top">
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <!--------------------------konten-------------------------------------------------------->
      <h3><i class="fa-solid fa-file"></i> Laporan Data Kehadiran Peserta</h3>
      <hr>


      <h3>MENAMPILKAN DATA KEHADIRAN PESERTA BALITA<br /></h3>
      ...
      <form method="get">
        ...
        <table style="width:100%">
          ...
          if (isset($_GET['tanggal'])) {
            $tgl = $_GET['tanggal'];
            $sql = mysqli_query($koneksi, "select * from kehadiran where tanggal='$tgl'");
          } else {
            $sql = mysqli_query($koneksi, "select * from kehadiran");
          }
        ...
        if (isset($_GET['tanggal'])) {
          ...
          <div class="float-right">
            <a href="../cetak/cetak_hadir.php?tanggal=<?= $tgl ?>" target="_blank" class="btn btn-success"><i class="fa-solid fa-print"></i> &nbsp PRINT</a>
            <a href="utama.php" class="btn btn-primary role" role=" button"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
            <br>
          </div>
        <?php } else { ?>
          <div class="float-right">
            <a href="../cetak/cetak_hadir.php" target="_blank" class="btn btn-success"><i class="fa-solid fa-print"></i> &nbsp PRINT</a>
            <a href="utama.php" class="btn btn-primary role" role=" button"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
          </div>
